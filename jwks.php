...
$PAGE->set_url('/local/placecom_mcp/jwks.php');
...
try {
    echo json_encode(local_placecom_mcp\utils::get_jwks(), JSON_UNESCAPED_SLASHES);
} catch (Throwable $exception) {
    debugging('local_placecom_mcp JWKS error: ' . $exception->getMessage(), DEBUG_DEVELOPER);
