...
use local_placecom_mcp_client;

defined('MOODLE_INTERNAL') || die();

global $CFG;
require_once($CFG->dirroot . '/local/placecom_mcp/lib.php');
 ...
 * @copyright   2026 AlmaBay Networks Pvt. Ltd. (Placecom) - namespace/table/path renames
 * @link        https://onbir.dev
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers      \local_placecom_mcp_client
 */
final class client_test extends advanced_testcase {
    ...
    public function test_client_instantiation(): void {
        ...
        $serverurl = 'http://example.com/local/placecom_mcp/server.php';
        $token = 'test_token_123';

        $client = new local_placecom_mcp_client($serverurl, $token);

        $this->assertInstanceOf(local_placecom_mcp_client::class, $client);
    }
    ...
    public function test_constructor_parameters(): void {
        ...
        $reflection = new ReflectionClass(local_placecom_mcp_client::class);
