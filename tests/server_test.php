...
use Exception;
use ReflectionClass;
use local_placecom_mcp\local\request;
 ...
 * @covers      \local_placecom_mcp\local\server
 */
final class server_test extends advanced_testcase {
    ...
    public function test_extract_tool_call_missing_name(): void {
        ...
        $this->expectExceptionMessage(get_string('err_missing_tool_name', 'local_placecom_mcp'));
