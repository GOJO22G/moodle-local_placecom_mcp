...
/**
 * local_placecom_mcp user not granted event.
 *
...
/**
 * The user_not_granted event class.
 */
class user_not_granted extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('event_user_not_granted', 'local_placecom_mcp');
    }
    ...
    public function get_description() {
        ...
        return "The user was not granted to access for $clientid to $scope.";
    }
