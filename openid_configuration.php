...
$PAGE->set_url('/local/placecom_mcp/openid_configuration.php');
...
try {
    echo json_encode(local_placecom_mcp\utils::get_openid_configuration(), JSON_UNESCAPED_SLASHES);
} catch (Throwable $exception) {
    debugging('local_placecom_mcp discovery error: ' . $exception->getMessage(), DEBUG_DEVELOPER);
